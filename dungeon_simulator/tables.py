...
PASSAGE_TABLE = RangeTable(20, [
    ...
    (12, 12, {"template": "Door in the right wall.", "side": "right", "next": "door"}),
    (13, 13, {"template": "Door in the left wall.", "side": "left", "next": "door"}),
    ...
    (17, 17, {"template": "Opening to the left, leading to stairs.", "side": "left", "next": "stairs"}),
    (18, 18, {"template": "Opening to the right, leading to stairs.", "side": "right", "next": "stairs"}),
