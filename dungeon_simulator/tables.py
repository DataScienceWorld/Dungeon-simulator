...
PASSAGE_TABLE = RangeTable(20, [
    ...
    (12, 12, {"template": "Door in the right wall. 50% chance the passage ends here, otherwise it continues.",
              "side": "right", "next": "door", "end_chance_pct": 50}),
    (13, 13, {"template": "Door in the left wall. 50% chance the passage ends here, otherwise it continues.",
              "side": "left", "next": "door", "end_chance_pct": 50}),
    (14, 14, {"template": "Secret door on a passage wall (Perception DC 15). 50% chance the passage ends here, otherwise it continues.",
              "side": "roll", "next": "secret_door_check", "end_chance_pct": 50}),
    ...
    (17, 17, {"template": "Opening to the left, leading to stairs. 50% chance the passage ends here, otherwise it continues.",
              "side": "left", "next": "stairs", "end_chance_pct": 50}),
    (18, 18, {"template": "Opening to the right, leading to stairs. 50% chance the passage ends here, otherwise it continues.",
              "side": "right", "next": "stairs", "end_chance_pct": 50}),
